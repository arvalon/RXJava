package ru.arvalon.rx.chapter7;
...
public class FileBrowserViewModel {
    ...
    public void subscribe() {
        ...
        Observable<File> rootFileObservable = rootClickObservable.map(event -> fileBrowserModel.getDefaultFolder());
        ...
        subscriptions.add(fileBrowserModel.getFilesList().subscribe(filesSubject::onNext));
    }
